      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 pt-5 sm:px-6 lg:px-8">
        <header className="flex flex-wrap items-center justify-between gap-4 border-b border-stone-200 pb-5">
          ...
          <nav className="flex flex-wrap items-center gap-x-5 gap-y-2 text-sm font-medium text-stone-600" aria-label={spanish ? "Navegación principal" : "Main navigation"}>
            ...
            <Link href="/etsy-sales-csv-analyzer" className="transition hover:text-stone-950">{spanish ? "Rentabilidad por SKU" : "Profit by SKU"}</Link>
            <Link href={spanish ? "/es/analizador-extracto-etsy" : "/etsy-payment-statement-analyzer"} className="transition hover:text-stone-950">{spanish ? "Extracto de pagos" : "Statement CSV"}</Link>
        ...
        <footer className="flex flex-wrap gap-x-5 gap-y-2 border-t border-stone-200 pt-6 text-xs text-stone-500">
          ...
          <Link href="/etsy-sales-csv-analyzer" className="underline underline-offset-4 hover:text-stone-900">{spanish ? "Rentabilidad por SKU" : "Profit by SKU"}</Link>
          <Link href={spanish ? "/es/analizador-extracto-etsy" : "/etsy-payment-statement-analyzer"} className="underline underline-offset-4 hover:text-stone-900">{spanish ? "Extracto de pagos" : "Statement CSV"}</Link>
