...
export const publicRoutes = [
  ...
  { path: "/lovable-custom-domain-not-working", lastModified: reviewedAt, priority: 0.9, changeFrequency: "monthly" as const },
  ...
  { path: "/es/dominio-personalizado-lovable-no-funciona", lastModified: reviewedAt, priority: 0.85, changeFrequency: "monthly" as const },
