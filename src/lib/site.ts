...
export const siteInfoRoutes = [
  { path: "/about", lastModified: new Date("2026-09-25T00:00:00.000Z"), priority: 0.3 },
  { path: "/privacy", lastModified: new Date("2026-09-25T00:00:00.000Z"), priority: 0.2 },
  { path: "/affiliate-disclosure", lastModified: new Date("2026-09-25T00:00:00.000Z"), priority: 0.2 },
];
