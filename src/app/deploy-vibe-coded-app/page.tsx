  ...
  return (
    ...
    >
      ...
      <section id="diagnostics" className="scroll-mt-6">
        ...
        <p className="mt-4 text-base leading-7">Deploying a Lovable project? Start with this <Link className={linkClass} href="/lovable-deployment-failed">guide to preview, Publish, build and live-site failures</Link>. For a Vercel 404, check the <Link className={linkClass} href="/lovable-to-vercel-checker">current version requirement and framework setup</Link>, then <Link className={linkClass} href="/where-to-host-lovable-app">compare hosting options if you are still choosing a provider</Link>.</p>
        <p className="mt-3 text-base leading-7">Using Bolt.new? Follow the <Link className={linkClass} href="/bolt-deployment-failed">Bolt publish and deployment troubleshooting guide</Link> to distinguish a preview issue from a hosted build failure.</p>
      </section>
