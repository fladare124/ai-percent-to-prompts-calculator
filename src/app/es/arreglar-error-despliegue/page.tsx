  ...
  return (
    ...
    >
      <section id="diagnostics" className="scroll-mt-6">
        ...
        <p className="mt-3 text-base leading-7">¿Usas Bolt.new? Consulta la <a className={linkClass} href="/es/error-despliegue-bolt">guía para distinguir fallos de vista previa, publicación en Bolt y despliegue externo</a>.</p>
      </section>
