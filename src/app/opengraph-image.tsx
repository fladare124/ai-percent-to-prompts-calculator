...
export const alt = "Free Etsy profit by SKU and private seller tools";
      ...
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "58px 68px", color: "#1c1917", background: "radial-gradient(circle at 88% 6%, #d1fae5 0, #f7f6f0 40%, #fafaf9 80%)", fontFamily: "Arial, sans-serif" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 42 }}>
          <div style={{ display: "flex", flexDirection: "column", flex: 1 }}>
            <div style={{ color: "#047857", fontSize: 17, fontWeight: 700, letterSpacing: 2 }}>FOR ETSY SHOP OWNERS</div>
            <div style={{ marginTop: 18, fontSize: 52, lineHeight: 1.08, fontWeight: 700 }}>See estimated profit by product across your shop.</div>
            <div style={{ marginTop: 20, color: "#57534e", fontSize: 22 }}>Order Items CSV · your costs and fee assumptions · private in your browser.</div>
          </div>
          <div style={{ width: 325, display: "flex", flexDirection: "column", gap: 13, padding: 19, border: "1px solid #d6d3d1", borderRadius: 22, background: "rgba(255, 255, 255, 0.88)" }}>
            {[["01", "Profit by SKU"], ["02", "Shop CSV audit"], ["03", "Sales and restock"], ["04", "US price plan"]].map(([number, label]) => (
