...
Listing Checkup is an independent set of free Etsy seller tools: a local active-listings CSV audit, single-listing title and tag checkers, a sales-by-product report, an inventory restock planner, and a US fee and profit estimate with reverse pricing for a target profit.
